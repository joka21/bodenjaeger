...
export default function VersandLieferzeitPage({ page }: VersandLieferzeitPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="content-container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto">
            {shippingOptions.map((option) => (
              ...
              >
                <div className="w-14 h-14 mb-4 bg-[#ed1b24]/10 rounded-full flex items-center justify-center text-[#ed1b24]">
                  {option.icon}
                </div>
                <h3 className="text-lg font-bold text-[#2e2d32] mb-1">{option.title}</h3>
                <div className="flex items-baseline gap-2 mb-3">
                  <span className="text-2xl font-bold text-[#ed1b24]">{option.price}</span>
                </div>
                <p className="text-sm text-gray-500 mb-3">{option.description}</p>
                <div className="flex items-center gap-1.5 text-sm font-medium text-[#2e2d32]">
          ...
          <div className="content-container">
            <div
              ...
              className="prose prose-lg max-w-3xl mx-auto
                [&_h1]:text-4xl [&_h1]:font-bold [&_h1]:text-[#2e2d32] [&_h1]:mb-6 [&_h1]:mt-10
                [&_h2]:text-2xl [&_h2]:md:text-3xl [&_h2]:font-bold [&_h2]:text-[#2e2d32] [&_h2]:mb-4 [&_h2]:mt-14
                [&_h3]:text-xl [&_h3]:md:text-2xl [&_h3]:font-bold [&_h3]:text-[#2e2d32] [&_h3]:mb-3 [&_h3]:mt-10
                ...
                [&_th]:bg-[#2e2d32] [&_th]:text-white [&_th]:px-4 [&_th]:py-3 [&_th]:text-left [&_th]:text-sm [&_th]:font-bold
                [&_td]:px-4 [&_td]:py-3 [&_td]:text-sm [&_td]:border-b [&_td]:border-gray-100
                [&_tr:nth-child(even)]:bg-[#f9f9fb]"
      ...
      {/* Delivery Process */}
      <section className="py-16 md:py-20 bg-[#f9f9fb]">
        <div className="content-container">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {deliverySteps.map((step, index) => (
              <div key={step.step} className="relative text-center">
                ...
                <div className="w-14 h-14 mx-auto mb-4 bg-[#ed1b24] rounded-full flex items-center justify-center text-white text-xl font-bold relative z-10">
                  {step.step}
                </div>
                <h3 className="text-base font-bold text-[#2e2d32] mb-2">{step.title}</h3>
            ...
            {faqs.map((faq) => (
              ...
              >
                <summary className="flex items-center justify-between px-6 py-5 cursor-pointer list-none">
                  <h3 className="text-base font-bold text-[#2e2d32] pr-4">{faq.question}</h3>
                  <svg
        ...
        <div className="content-container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                href="/kontakt"
                className="inline-flex items-center gap-2 px-8 py-3.5 border-2 border-[#2e2d32] text-[#2e2d32] font-bold rounded-lg hover:bg-[#2e2d32] hover:text-white transition-colors"
              >
                Zum Kontaktformular
              </a>
            </div>
